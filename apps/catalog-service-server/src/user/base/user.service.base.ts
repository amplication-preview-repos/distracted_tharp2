...
export class UserServiceBase {
  ...
  async CreateUserAccount(args: RegisterInput): Promise<RegisterOutput> {
    throw new Error("Not implemented");
  }
  async EnableTwoFactorAuth(args: string): Promise<string> {
    throw new Error("Not implemented");
  }
  async Register(args: string): Promise<string> {
    throw new Error("Not implemented");
  }
  async UserRegister(args: string): Promise<string> {
    throw new Error("Not implemented");
  }
  async VerifyTwoFactorAuth(args: string): Promise<string> {
    throw new Error("Not implemented");
  }
}
